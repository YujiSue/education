...
def sample():
  ...
  dat01 = 診療データ()
  dat01.診療情報の記入({'名称':'定期健康診断','項目': [{'名称': '身長 (cm)'}, {'名称': '体重 (kg)'}, {'名称': '視力(両眼)'}, {'名称': '血圧(mmHg)'}]})
  dat02 = 診療データ()
  dat02.診療情報の記入({'名称':'血液検査','項目': [{'名称': '赤血球数'}, {'名称': '白血球数'}, {'名称': 'γ-GTP '}, {'名称': '血糖　　'}]})
  dat03 = 診療データ()
  dat03.診療情報の記入({'名称':'新型コロナ検査','項目': [{'名称': '体温'}, {'名称': 'せき'}, {'名称': '味覚'}, {'名称': 'PCR '}]})
